...
procedures = [
    ...
    {"id": 4, 
     ...
     "stars": 1,
     "moreinfo":"""
        Pollution is the introduction of harmful substances or contaminants into the environment, causing adverse effects on ecosystems, human health, and the planet's natural processes. Common pollutants include chemicals, particulate matter, and waste products from industrial activities, transportation, and agricultural practices. Air pollution, characterized by smog and toxic emissions, contributes to respiratory diseases and climate change. Water pollution, caused by the discharge of pollutants into rivers, lakes, and oceans, affects marine life and contaminates drinking water sources. Soil pollution degrades land quality and can lead to the loss of arable land. Efforts to reduce pollution focus on adopting cleaner technologies, implementing stricter regulations, and promoting sustainable practices to protect the environment and public health.
        """},
]
